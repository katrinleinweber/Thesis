...
When it comes to sampling there are many different methods which can be used, but not all of them are applicable to point clouds. In Lee et al\cite{lee2001data}  two of these methods get explained and tested against some other methods.
\begin{itemize}
