...
\begin{itemize}
\item Point clouds from landscapes and coastlines usually contain several thousands to millions of points. Thus resulting in a lot of computation time, even for simple operations.
